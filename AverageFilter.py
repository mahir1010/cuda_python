...
def avg_filter(pixels,m,n):
	...
	Example:
		...
		kernel=[0,0,32,0,0,22,6,0,102]
		average= (0+0+32+0+0+22+6+0+102) // 9 =18
		output in image = [18,18,18,18,18,18,18,18,18]
	...
	Note:
		...
		of the image
		For first block, the center of the 2d-kernel would be the first pixel of the image therefore the pixels at position:
